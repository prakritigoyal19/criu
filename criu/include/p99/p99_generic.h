...
void p00_sprint_p99x_uintmax_u_ite(p99x_uintmax p00_val, char*restrict p00_str) {
  ...
  p00_str += sprintf(p00_str, strcpy("%", PRIu64), (uint64_t)p00_val);
  while (p00_pos) {
    --p00_pos;
    p00_str += sprintf(p00_str, strcpy("%019", PRIu64), p00_ar[p00_pos]);
  }
}
p99_inline
...
void p00_sprint_p99x_uintmax_o_ite(p99x_uintmax p00_val, char*restrict p00_str) {
  ...
  p00_str += sprintf(p00_str, strcpy("%#", PRIo64), p00_ar[p00_pos]);
  while (p00_pos) {
    --p00_pos;
    p00_str += sprintf(p00_str, strcpy("%021", PRIo64), p00_ar[p00_pos]);
  }
}
p99_inline
...
void p00_sprint_p99x_uintmax_X_ite(p99x_uintmax p00_val, char*restrict p00_str) {
  ...
  p00_str += sprintf(p00_str, strcpy("%#", PRIX64), p00_ar[p00_pos]);
  while (p00_pos) {
    --p00_pos;
    p00_str += sprintf(p00_str, strcpy("%016", PRIX64), p00_ar[p00_pos]);
  }
}
p99_inline
